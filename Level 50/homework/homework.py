...
try:
    print(undefined_variable)  # შეცდომა: ცვლადი არ არის განსაზღვრული
except NameError:
...
try:
    lst = [1, 2, 3]
    print(lst[5])  # შეცდომა: სია არ შეიცავს ამ ინდექსზე ელემენტს
except IndexError:
    print("მოხდა IndexError! სიის ინდექსი არასწორია.")

# ValueError-ის მაგალითი
try:
    num = int("abc")  # შეცდომა: სტრიქონი არ გარდაიქმნება მთელ რიცხვად
except ValueError:
    print("მოხდა ValueError! ვერ გადავიყვანე სტრიქონი რიცხვად.")

# Try/except-ის გამოყენება გვაძლევს საშუალებას:
# - მოვაგვაროთ შეცდომები და არ გავაჩეროთ პროგრამის შესრულება.
